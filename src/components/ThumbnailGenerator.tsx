    ...
    <Card>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="image-upload">Upload a Base Image (Optional)</Label>
            {imageBase64 ? (
              <div className="relative w-full max-w-sm">
                ...
                <div className="flex items-center justify-center w-full">
                    <label htmlFor="image-upload" className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg bg-card ${isLoading ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:bg-muted/50 transition-colors'}`}>
